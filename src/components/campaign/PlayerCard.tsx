      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-muted">Lv. {pc.level} {pc.race} {pc.class_name}</span>
          </div>
          <p className="text-sm text-muted">Player: {pc.player_name}</p>
          <div className="flex gap-4 text-xs text-muted mt-1 font-data">
            <span>AC {pc.armor_class}</span>
            <span>HP {pc.hit_points}</span>
          </div>
        </div>
