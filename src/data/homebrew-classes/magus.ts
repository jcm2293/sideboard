...
// ──────────────────────────────────────────────────────────────────────────
// Fighting Styles (informational — chosen via the wizard's free-text field)
// ──────────────────────────────────────────────────────────────────────────

const FIGHTING_STYLES: FeatureDefinition[] = [
  { id: 'fs_archery', name: 'Archery', description: 'Prereq: DEX 13+. +1 to attack rolls with ranged weapons; ranged attacks ignore half-cover and treat three-quarters cover as half-cover.' },
  { id: 'fs_balanced', name: 'Balanced Fighting', description: 'When wielding a melee weapon in one hand and no other weapons, +2 to weapon damage rolls. Shield-compatible.' },
  { id: 'fs_classical', name: 'Classical Swordplay', description: 'Prereq: DEX 13+. While wielding a single finesse weapon, no shield, and not wearing heavy armor, +2 to attack rolls with that weapon and +1 AC.' },
  { id: 'fs_defensive', name: 'Defensive Fighting', description: 'When wearing medium or heavy armor or a shield, +1 AC.' },
  { id: 'fs_dual', name: 'Dual Wielding', description: 'Prereq: STR or DEX 13+. Two-weapon: off-hand attack is part of your Attack action (not a bonus action), and you add your ability mod to its damage. Cannot use bonus action to attack that turn.' },
  { id: 'fs_hurler', name: 'Hurler', description: 'Prereq: STR or DEX 11+. Draw a thrown weapon as part of a ranged attack with it; thrown weapon range is doubled. With only thrown weapons, make a single thrown ranged attack as a bonus action.' },
  { id: 'fs_protection', name: 'Protection', description: 'When a creature you can see hits you, or a target within 5 feet with a melee attack, use a reaction to add your PB to the target\'s AC against that attack. Requires shield or melee weapon.' },
  { id: 'fs_versatile', name: 'Versatile Fighting', description: 'Prereq: STR or DEX 11+. While wielding a single versatile weapon and no shield, +1 to attack rolls with that weapon. May use bonus action for a Grapple/Shove/Use an Object.' },

  // Expanded
  { id: 'fs_arcane_warrior', name: 'Arcane Warrior', description: 'Prereq: proficiency in Arcana. Learn two Cantrips of your choice from the Wizard spell list (do not count against Cantrips Known). INT is their spellcasting ability; once you gain Spellcasting they count as Magus spells.' },
  { id: 'fs_brawling', name: 'Brawling', description: 'Prereq: proficiency in Athletics. Unarmed strikes deal 1d6 + STR. With both hands free, use a bonus action for a single unarmed strike, Shove, or Grapple each turn.' },
  { id: 'fs_featherweight', name: 'Featherweight Fighting', description: 'Prereq: DEX 13+, proficiency in Acrobatics. While unarmed or wielding only light weapons, no medium/heavy armor: +10 ft. walking speed and +1 damage with light melee weapons and unarmed strikes.' },
  { id: 'fs_great_weapon', name: 'Great Weapon Fighting', description: 'Prereq: STR 13+. Reroll a 1 or 2 on damage with a heavy melee weapon (treat low rolls as their average if higher).' },
  { id: 'fs_heavyweight', name: 'Heavyweight Fighting', description: 'Prereq: STR 13+. +1 damage with heavy melee weapons. On hit with a heavy melee weapon, use a bonus action to make a Shove against the same target with advantage.' },
  { id: 'fs_mounted', name: 'Mounted Warrior', description: 'Prereq: proficiency in Animal Handling. While riding a controlled mount, both you and your mount gain +1 AC, and you can use a bonus action each turn to command your mount.' },
  { id: 'fs_polearm', name: 'Polearm Fighting', description: 'Prereq: STR and DEX 11+. +1 damage with glaives, halberds, pikes, quarterstaffs, and spears (no shield). Creatures provoke OAs when entering or moving within your reach with that weapon.' },
  { id: 'fs_shield_warrior', name: 'Shield Warrior', description: 'Prereq: STR 13+. Shield proficiency as a martial melee weapon (shield attacks deal 2d4 bludgeoning). With shield and no other weapon, +1 AC and +1 to shield attack rolls.' },
];
